<template>
  <div v-if="loading === true" class="container flex items-center">
      ...
      <div class="col">
        <div class="row">
          <div class="col text-left">
            ...
            <div v-if="category.description" class="q-mt-sm text-grey-8">
        ...
        <div class="row text-left q-col-gutter-xl q-pb-md q-pt-lg">
          ...
          >
            <q-img
              ...
              :ratio="1"
            />
            <div class="overflow-ellipsis text-bold text-grey-10">
              {{ collection.title }}
            </div>
            <div class="overflow-ellipsis text-grey-7">
