  ...
  <div class="row item-card narrow-item-card" v-if="item">
    <div class="row details">
      <div class="category-image q-py-sm">
        <router-link class="no-decoration" :to="`/items/${item.documentId}`">
          <q-img
            :src="
              item &&
              item.featured_image &&
              typeof item.featured_image.url === 'string'
                ...
                : item.categories[0].featured_image.url ||
    ...
    <div class="row" style="width: 100%">
      <div class="col-12 q-pb-xs q-mx-0">
        <q-expansion-item switch-toggle-side header-class="resources">
          <template v-slot:header>
            <div
              class="row items-center justify-between q-mx-0"
              style="width: 100%"
            >
